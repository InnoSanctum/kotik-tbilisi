...
(function () {
  ...
  var UI_STRINGS = {
    ru: {
      ...
      navGigs: 'Выступления',
      gigsTitle: 'Благотворительные выступления',
      gigsEmpty: 'Выступлений пока нет.',
      gigUpcoming: 'Скоро',
      gigPast: 'Состоялось',
      gigVenue: 'Место',
      gigSupports: 'В поддержку',
      gigMore: 'Подробнее',
      gigLink: 'Страница события',
      backToGigs: 'Ко всем выступлениям',
      gigNotFound: 'Такого выступления нет или ссылка устарела.',
      adminGigs: 'Выступления',
      adminPets: 'Подопечные',
      adminNewGig: 'Добавить выступление',
      /* admin */
    ...
    en: {
      ...
      navGigs: 'Performances',
      gigsTitle: 'Charity performances',
      gigsEmpty: 'No performances yet.',
      gigUpcoming: 'Upcoming',
      gigPast: 'Took place',
      gigVenue: 'Venue',
      gigSupports: 'In support of',
      gigMore: 'Read more',
      gigLink: 'Event page',
      backToGigs: 'All performances',
      gigNotFound: 'This performance does not exist, or the link is out of date.',
      adminGigs: 'Performances',
      adminPets: 'Animals',
      adminNewGig: 'Add a performance',
    ...
    ka: {
      ...
      navGigs: 'გამოსვლები',
      gigsTitle: 'საქველმოქმედო გამოსვლები',
      gigsEmpty: 'გამოსვლები ჯერ არ არის.',
      gigUpcoming: 'მალე',
      gigPast: 'შედგა',
      gigVenue: 'ადგილი',
      gigSupports: 'მხარდასაჭერად',
      gigMore: 'ვრცლად',
      gigLink: 'ღონისძიების გვერდი',
      backToGigs: 'ყველა გამოსვლა',
      gigNotFound: 'ასეთი გამოსვლა არ არსებობს, ან ბმული მოძველებულია.',
      adminGigs: 'გამოსვლები',
      adminPets: 'ცხოველები',
      adminNewGig: 'გამოსვლის დამატება',
